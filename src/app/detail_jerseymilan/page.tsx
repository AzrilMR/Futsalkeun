...
export default function Detail(){
    return(
        <div>
            ...
            <h1 className="absolute top-30 left-165 text-4xl font-bold">AC MILAN HOME JERSEY 95/96</h1>
            ...
            <h2 className="absolute top-135 left-165 text-3xl">RP. 799,000.00</h2>
