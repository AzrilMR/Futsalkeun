...
export default function Detail(){
    return(
        ...
        <Link href="/jersey">
            ...
            <h1 className="absolute top-30 left-165 text-4xl font-bold">BORUSSIA DORTMUND HOME JERSEY 25/26</h1>
            ...
            <h2 className="absolute top-135 left-165 text-3xl">RP. 540,000.00</h2>
