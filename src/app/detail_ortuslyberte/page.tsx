...
export default function Detail(){
    return(
        ...
        <Link href="/sepatu">
            ...
            <p className="absolute top-70 left-165 text-lg text-justify w-[700] bg-[#FAFAFA] opacity-75 p-7 rounded-xl inset-shadow-sm">Dirancang untuk kecepatan. Ortuseight Catalyst Liberte V4 hadir dengan upper berbahan mesh super ringan yang pas di kaki, 
                    memberikan Anda kelincahan untuk melewati lawan di lapangan.</p>
