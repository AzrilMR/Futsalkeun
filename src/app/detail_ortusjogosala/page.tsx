...
export default function Detail(){
    return(
        ...
        <Link href="/sepatu">
            ...
            <h1 className="absolute top-30 left-165 text-4xl font-bold">ORTUSEIGHT-JOGOSALA VANQUISH</h1>
            <h2 className="absolute top-40 left-165 text-2xl mt-3 mb-3">Abu-abu</h2>
            ...
            <h2 className="absolute top-135 left-165 text-3xl">RP. 399,000.00</h2>
