  ...
  return(
     <div>
            ...
            <Link href="/sepatu">
                ...
                <h1 className="absolute top-30 left-165 text-4xl font-bold">ORTUSEIGHT-CATALYST LEGION V5</h1>
                <h2 className="absolute top-40 left-165 text-2xl mt-3 mb-3">Aqua</h2>
                ...
                <h2 className="absolute top-135 left-165 text-3xl">RP. 299,550.00</h2>
